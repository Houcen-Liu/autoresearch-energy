...
Cursaru \etal \cite{cursaru2024codellama} run a controlled experiment on the energy efficiency of Code Llama-generated source code, using the same methodological school (GQM, factorial design, \texttt{experiment-runner}). Their unit of analysis is the generated artifact; ours is the generating loop itself: we measure the energy of the agentic process, not of its outputs.
...
$E_{\mathit{prop}}$ is only 40--60\,\% of session energy and proposal quality
...
compose: in our sessions 64\,\% of energy went to mutations that were reverted,
i.e.\ to running generated code that was then discarded. A study of generated-code
efficiency measures the 36\,\%; the remainder is invisible to it and is where the
architectural difference between our arms appears most strongly.
