...
def augment(xb: torch.Tensor) -> torch.Tensor:
    """Data augmentation with padding and random cropping."""
    # Add padding
    xb = F.functional.pad(xb, (4, 4, 4, 4), padding_mode='reflect')
    # Random crop
    return F.functional.interpolate(F.functional.resize(xb, 32), size=(32, 32))
