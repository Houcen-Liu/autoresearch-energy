...
def augment(xb: torch.Tensor) -> torch.Tensor:
    ...
    # Add random horizontal flips, cutmix, and mixup
...
def main() -> int:
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(opt, T_max=10, eta_min=0.001)
